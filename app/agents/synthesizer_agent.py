"""
SynthesizerAgent: agent wrapper around the synthesizer node factory.
...
from app.graph.nodes import make_synthesizer_node
...
class SynthesizerAgent(BaseAgent):
    ...
    def __init__(self, deps: AgentDeps):
        ...
        self._fn = make_synthesizer_node(deps)
