"""
ContextAgent: agent wrapper around the context_resolver node factory.
...
from app.graph.nodes import make_context_resolver_node
...
class ContextAgent(BaseAgent):
    ...
    def __init__(self, deps: AgentDeps):
        ...
        self._fn = make_context_resolver_node(deps)
